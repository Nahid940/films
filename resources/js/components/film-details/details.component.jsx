                ...
                <div className="col-md-8 ">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <img src={film.photo?`/storage/${film.photo}`:'/img.png'} alt="Film Poster"/>
                                    ...
                                    <div className="media" key={index}>
                                        <div className="media-body">
                                            <div className="comment-user">
                                                ...
                                                <h6 className="media-heading user_name text-primary">{comment.name}</h6> <span className="text-danger text-small"> {comment.created_at}</span>
                                            </div>
